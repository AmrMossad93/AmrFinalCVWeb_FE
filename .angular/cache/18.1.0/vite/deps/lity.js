...
var require_lity = __commonJS({
  "node_modules/lity/dist/lity.js"(exports, module) {
    (function(window2, factory) {
      if (typeof define === "function" && define.amd) {
        ...
        window2.lity = factory(window2, window2.jQuery || window2.Zepto);
      }
      ...
      function Lity(target, options, opener, activeElement) {
        ...
        function ready(result2) {
          content = $(result2).css("max-height", winHeight() + "px");
